...
class SLCPGaussian(Task):
    def __init__(self, distractors: bool = False):
        ...
        if not self.distractors:
            ...
            name = "slcp_gaussian"
            name_display = "SLCP Gaussian"
        else:
            dim_data = 100
            name = "slcp_gaussian_distractors"
            name_display = "SLCP Gaussian Distractors"
    ...
    def _get_transforms(
        ...
        **kwargs: Any,
        ...
        if not self.distractors:
            ...
            task = SLCPGaussian(distractors=False)
    ...
    def _sample_reference_posterior(
        ...
        proposal_dist = task.get_prior_dist()
